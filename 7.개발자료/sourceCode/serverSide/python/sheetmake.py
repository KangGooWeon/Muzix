...
def save_midi(outfile, notes, tempo):
    ...
    for note in notes:
        ...
        midifile.addNote(melodi_track, channel, pitch, onset, duration, melodi_volume)
...
if __name__ =='__main__':
    audio_to_midi_melodia('good-morning1.wav', 'good-mornig.mid', 60, smooth=0.25, minduration=0.1,
                           savejams=False)
