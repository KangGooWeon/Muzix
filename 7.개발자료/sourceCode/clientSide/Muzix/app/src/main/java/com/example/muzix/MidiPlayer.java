...
public class MidiPlayer extends LinearLayout {
    ...
    private ImageButton modifySheetButton; /** The modify sheet music button*/
    ...
    void init() {
        inflate(activity, R.layout.player_layout, this);
        ...
        modifySheetButton = findViewById(R.id.btn_modify);
        ...
        modifySheetButton.setOnClickListener(v -> openModifyToolbar());
    ...
    private void openModifyToolbar(){
        Intent intent = new Intent(activity, ModifySheetMusicActivity.class);
        intent.putExtra(ModifySheetMusicActivity.MidiTitleID, midifile.getFileName());
    ...
    public void SetMidiFile(MidiFile file, MidiOptions opt, SheetMusic s) {
        ...
        if(!midifile.getWriter().equals(pref.getString("MUZIXID", null)))
            modifySheetButton.setVisibility(View.GONE);
    }
